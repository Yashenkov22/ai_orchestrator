...
Revision ID: ebd1f02b2438
Revises: d27e202f38d2
Create Date: 2026-04-15 21:21:54.032704
...
revision: str = 'ebd1f02b2438'
down_revision: Union[str, None] = 'd27e202f38d2'
...
def upgrade() -> None:
    ...
    op.add_column('accounts', sa.Column('proxy_url', sa.String(), nullable=True))
    op.add_column('accounts', sa.Column('is_parse', sa.Boolean(), nullable=True))
