"""add new fileds to Accounts, InstaUser, Threads

Revision ID: 51b07621c9ef
Revises: 8ce93a319ef4
Create Date: 2026-05-17 15:04:24.217791
...
revision: str = '51b07621c9ef'
down_revision: Union[str, None] = '8ce93a319ef4'
...
def upgrade() -> None:
    ...
    op.add_column('accounts', sa.Column('photo_url', sa.String(length=2048), nullable=True))
    op.add_column('accounts', sa.Column('folder_id', sa.String(), nullable=True))
    op.add_column('accounts', sa.Column('profile_id', sa.String(), nullable=True))
    op.add_column('accounts', sa.Column('information', sa.Text(), nullable=True))
    op.create_unique_constraint(None, 'accounts', ['photo_url'])
    op.add_column('threads', sa.Column('user_information', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('threads', sa.Column('color_level', sa.String(), nullable=False, server_default='grey'))
    op.add_column('users', sa.Column('full_name', sa.String(), nullable=True))
    op.add_column('users', sa.Column('photo_url', sa.String(length=2048), nullable=True))
    op.create_unique_constraint(None, 'users', ['photo_url'])
...
def downgrade() -> None:
    ...
    op.drop_column('threads', 'color_level')
    op.drop_column('threads', 'user_information')
    op.drop_constraint(None, 'accounts', type_='unique')
    op.drop_column('accounts', 'information')
