...
Revision ID: 8ce93a319ef4
Revises: ebd1f02b2438
Create Date: 2026-05-05 17:20:26.347775
...
revision: str = '8ce93a319ef4'
down_revision: Union[str, None] = 'ebd1f02b2438'
...
def upgrade() -> None:
    ...
    op.add_column('threads', sa.Column('is_unread', sa.Boolean(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('threads', 'is_unread')
